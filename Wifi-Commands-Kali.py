...
def display_help():
    ...
    commands = [
        ...
        ["jam", "Perform Wi-Fi jamming attacks (with speed control)"],  
        ["wps", "Test for WPS vulnerabilities"],
        ["evil", "Create an evil twin access point"],
        ["sniff", "Sniff wireless traffic for credentials"],
        ["nmap", "Run nmap network scans"],
        ["arpspoof", "Perform ARP spoofing attacks"],
        ["mac", "Change the MAC address of an interface"],
        ["mitm", "Set up a MITM proxy for traffic inspection"],
        ["dnsspoof", "Perform DNS spoofing attacks"],
